...
#import "VegiCalcTableViewController.h"
#import "Parse/Parse.h"
#import "VegiCalcDetailViewController.h"

@interface VegiCalcTableViewController ()

@property (nonatomic, strong) NSArray *vegiArray;

@end

@implementation VegiCalcTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"VegiCell" forIndexPath:indexPath];
