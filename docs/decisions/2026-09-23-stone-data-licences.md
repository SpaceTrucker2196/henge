...
| Cleal, Walker & Montague 1995, *Stonehenge in its Landscape*, Appendix 5, via the Archaeology Data Service | Height above ground per stone | ADS Terms of Use and Access: use and adaptation for historic-environment research "including as part of the commercial sector", with acknowledgement | **In**, with the ADS credit line. Vendored the same day as `Sources/HengeGeometry/Resources/stones/cleal-1995-appendix5.csv`, transcribed from pp 547–548 of the ADS PDF. |
| Petrie 1880, *Stonehenge: Plans, Description, and Theories*, pp 10–12 | Height and top level per stone in 1877 | Public domain | **In.** Vendored the same day as `Sources/HengeGeometry/Resources/stones/petrie-1880-heights.csv`, from the Google Books scan; used as the independent check, never as a replacement. |
